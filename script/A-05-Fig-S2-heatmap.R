...
##
forage.traits.gl <- forage.traits
forage.traits.gl$distance <- forage.traits.gl$distance/1000
...
forage.traits.gl$nm1 <- predict(all_social_mod,forage.traits.gl,
                                    re_formula = ~(1|species)+(1|genus),
                                    transform = exp)[,1]/1000 #
forage.traits.gl$nm2 <- predict(all_social_mod,forage.traits.gl,
                                    re_formula = ~(1|genus),
                                    transform = exp)[,1]/1000 #
forage.traits.gl$nm3 <- predict(all_social_mod,forage.traits.gl,
                                    re_formula = NA,
                                    transform = exp)[,1]/1000 #
...
ggsave(mean.hm.gg/
  ...
  file="plots/Figure S2 final.pdf",
  device = cairo_pdf,
  width=8,
  height=8,
  units="in",
...
ggsave(mean.hm.gg/
         max.hm.gg+plot_layout(guides = "collect"),
       file="plots/Figure S2 final.jpg",
       device = "jpg",
       width=8,
       height=8,
       units="in",
