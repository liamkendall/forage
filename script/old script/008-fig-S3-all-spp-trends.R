...
species.draws.max.1.r <- max_social_mod%>%
  add_predicted_draws(newdata = max.species.l,
                      re_formula = ~(1|species)+(1|genus),
                      allow_new_levels=T,
                      transform=exp)

species.draws.max.2.r <- max_social_mod%>%
  add_predicted_draws(newdata = max.species.l,
                      re_formula = ~(1|genus),
                      allow_new_levels=T,
                      transform=exp)

species.draws.max.3.r <- max_social_mod%>%
  add_predicted_draws(newdata = max.species.l,
                      re_formula = NA,
                      allow_new_levels=T,
                      transform=exp)
...
species.draws.mean.1.r <- typ_social_mod%>%
  add_predicted_draws(newdata = max.species.l,
                      re_formula = ~(1|species)+(1|genus),
                      allow_new_levels=T,
                      transform=exp)

species.draws.mean.2.r <- typ_social_mod%>%
  add_predicted_draws(newdata = max.species.l,
                      re_formula = ~(1|genus),
                      allow_new_levels=T,
                      transform=exp)

species.draws.mean.3.r <- typ_social_mod%>%
  add_predicted_draws(newdata = max.species.l,
                      re_formula = NA,
                      allow_new_levels=T,
                      transform=exp)
...
ggsave(sp.max.plots,file="plots/Figure S3A.jpeg",
       device = "jpeg", 
       width = 210, 
       height = 297, 
       units = "mm",
       dpi = 300)
ggsave(sp.max.plots,file="plots/Figure S3A.pdf",
       device = cairo_pdf, 
       width = 210, 
       height = 297, 
       units = "mm",
...
ggsave(sp.typ.plots,file="plots/Figure S3B.jpeg",
       device = "jpeg", 
       width = 210, 
       height = 297, 
       units = "mm",
       dpi = 300)
ggsave(sp.typ.plots,file="plots/Figure S3B.pdf",
       device = cairo_pdf, 
       width = 210, 
       height = 297, 
       units = "mm",
