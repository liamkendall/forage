...
forage.traits.max.gl$nm1 <- predict(max_social_mod,forage.traits.max.gl,
                                    re_formula = ~(1|species)+(1|genus),
                                    transform = exp)[,1]/1000 #
forage.traits.max.gl$nm2 <- predict(max_social_mod,forage.traits.max.gl,
                                    re_formula = ~(1|genus),
                                    transform = exp)[,1]/1000 #
forage.traits.max.gl$nm3 <- predict(max_social_mod,forage.traits.max.gl,
                                    re_formula = NA,
                                    transform = exp)[,1]/1000 #
...
forage.traits.mean.gl$nm1 <- predict(typ_social_mod,forage.traits.mean.gl,
                                    re_formula = ~(1|species)+(1|genus),
                                    transform = exp)[,1]/1000 #
forage.traits.mean.gl$nm2 <- predict(typ_social_mod,forage.traits.mean.gl,
                                    re_formula = ~(1|genus),
                                    transform = exp)[,1]/1000 #
forage.traits.mean.gl$nm3 <- predict(typ_social_mod,forage.traits.mean.gl,
                                    re_formula = NA,
                                    transform = exp)[,1]/1000 #
