...
pred.draws.1.r <- all_social_mod%>%
  add_predicted_draws(newdata = example.preds.1,
                      re_formula = ~(1|species)+(1|genus),
                      transform=exp)

pred.draws.2.r <- all_social_mod%>%
  add_predicted_draws(newdata = example.preds.1,
                      re_formula = ~(1|genus),
                  transform=exp)

pred.draws.3.r <- all_social_mod%>%
  add_predicted_draws(newdata = example.preds.1,
                      re_formula = NA,
                      transform=exp)
...
ggsave(species.plot.all,file="plots/Figure S4 final.pdf",
       device="pdf",
       width=9,
       height=7,
       units = "in",
...
ggsave(species.plot.all,file="plots/Figure S4 final.jpg",
       device="jpg",
       width=9,
       height=7,
       units = "in",
